...
class IssuereturnBook extends Model
{
    use AdmikoFileUploadTrait,AdmikoAuditableTrait,AdmikoMultiTenantModeTrait;

    public $table = 'issuereturn_book';
    
    
	const STATUS_CONS = ["Issue"=>"Issue","Return"=>"Return"];
    protected $dates = [
        'created_at',
        'updated_at',
        'deleted_at',
    ...
    public function book_name_id()
    {
        return $this->belongsTo(BookList::class, 'book_name');
    }
