            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="first_name" class="col-md-2 col-form-label">Full Name:*</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="first_name" name="first_name" required="true" placeholder="Full Name"  value="{{{ old('first_name', isset($data)?$data->first_name : '') }}}">
