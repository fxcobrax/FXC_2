...
@section('breadcrumbs')
    <li class="breadcrumb-item active"><a href="{{ route("admin.classtest.index") }}">Classtest</a></li>
    @if(isset($data))
...
@endsection
@section('backBtn')
<a href="{{ route("admin.classtest.index") }}"><i class="fas fa-angle-left"></i> {{trans('admiko.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage classtest_manage admikoForm">
            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="test_name" name="test_name"  placeholder="Test Name"  value="{{{ old('test_name', isset($data)?$data->test_name : '') }}}">
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("admin.classtest.index") }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
