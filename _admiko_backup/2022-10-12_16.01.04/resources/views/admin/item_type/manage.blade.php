...
@section('breadcrumbs')
    <li class="breadcrumb-item active"><a href="{{ route("admin.item_type.index") }}">Item Type</a></li>
    @if(isset($data))
...
@endsection
@section('backBtn')
<a href="{{ route("admin.item_type.index") }}"><i class="fas fa-angle-left"></i> {{trans('admiko.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage item_type_manage admikoForm">
                    ...
                    <div class="form-group row multiSelect">
                        ...
                        <div class="col-md-10" style="position: relative">
                            <select class="form-select" id="category" name="category" required="true" data-placeholder="{{trans('admiko.select')}}" style="width: 100%" data-width="100%" data-allow-clear="true">
                                ...
                                @foreach($item_category_all as $id => $value)
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("admin.item_type.index") }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
