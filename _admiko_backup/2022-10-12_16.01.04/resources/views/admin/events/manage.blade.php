...
@endsection
@section('backBtn')
<a href="{{ route("admin.events.index") }}"><i class="fas fa-angle-left"></i> {{trans('admiko.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage events_manage admikoForm">
    ...
    <form method="POST" action="{{ $admiko_data['formAction'] }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="event_info" class="col-md-2 col-form-label">Event Info:</label>
                        <div class="col-md-10">
                            <textarea class="form-control form-control-textarea simple_text_editor" id="event_info" name="event_info"  placeholder="Event Info">{{{ old('event_info', isset($data)?$data->event_info : '') }}}</textarea>
                            <div class="invalid-feedback @if ($errors->has('event_info')) d-block @endif">{{trans('admiko.required_text')}}</div>
                            <small id="event_info_help" class="text-muted"></small>
                        </div>
                    </div>
                </div>
                <div class=" col-12">
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("admin.events.index") }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
