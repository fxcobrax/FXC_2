...
@section('breadcrumbs')
    <li class="breadcrumb-item active"><a href="{{ route("admin.examination.index") }}">Examination</a></li>
    @if(isset($data))
...
@endsection
@section('backBtn')
<a href="{{ route("admin.examination.index") }}"><i class="fas fa-angle-left"></i> {{trans('admiko.page_back_btn')}}</a>
@endsection
@section('content')
<div class="card formPage examination_manage admikoForm">
            ...
            <div class="row">
                ...
                <div class=" col-12">
                    <div class="form-group row">
                        <label for="exams_name" class="col-md-2 col-form-label">Exams Name:</label>
                        <div class="col-md-10">
                            <input type="text" class="form-control" id="exams_name" name="exams_name"  placeholder="Exams Name"  value="{{{ old('exams_name', isset($data)?$data->exams_name : '') }}}">
                            <div class="invalid-feedback @if ($errors->has('exams_name')) d-block @endif">{{trans('admiko.required_text')}}</div>
                            <small id="exams_name_help" class="text-muted"></small>
                        </div>
                    </div>
                </div>
                <div class=" col-12">
        ...
        <div class="card-footer form-actions" id="form-group-buttons">
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <a href="{{ route("admin.examination.index") }}" class="btn btn-secondary float-end" role="button">{{trans('admiko.table_cancel')}}</a>
                </div>
            </div>
        </div>
    </form>
