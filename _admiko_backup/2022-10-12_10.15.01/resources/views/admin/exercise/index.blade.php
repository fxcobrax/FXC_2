            ...
            <div class="tableLayout pb-2">
                    ...
                    <thead>
                        <tr data-sort-method='thead'>
							...
							<th scope="col" class="text-nowrap d-none d-sm-table-cell">Marks</th>
							<th scope="col" class="d-none d-md-table-cell">Date</th>
							<th scope="col" class="text-nowrap d-none d-lg-table-cell">Status</th>
							<th scope="col" class="text-nowrap d-none d-lg-table-cell">Description</th>
                    ...
                    @foreach($tableData as $data)
                        <tr>
							...
							<td class="text-nowrap d-none d-sm-table-cell">{{$data->marks}}</td>
							<td class="d-none d-md-table-cell">{{$data->date}}</td>
							<td class="text-nowrap d-none d-lg-table-cell">{{$data->status_id->status??""}}</td>
							<td class="text-nowrap d-none d-lg-table-cell">{{$data->description}}</td>
