...
/**ExeatType**/
Route::delete("exeat_type/destroy", [ExeatTypeController::class,"destroy"])->name("exeat_type.delete");
Route::resource("exeat_type", ExeatTypeController::class)->parameters(["exeat_type" => "exeat_type"]);
/**SignExeat**/
Route::delete("sign_exeat/destroy", [SignExeatController::class,"destroy"])->name("sign_exeat.delete");
Route::resource("sign_exeat", SignExeatController::class)->parameters(["sign_exeat" => "sign_exeat"]);
/**BookCategory**/
...
/**DormRooms**/
Route::delete("dorm_rooms/destroy", [DormRoomsController::class,"destroy"])->name("dorm_rooms.delete");
Route::resource("dorm_rooms", DormRoomsController::class)->parameters(["dorm_rooms" => "dorm_rooms"]);
/**AssignDormitory**/
Route::delete("assign_dormitory/destroy", [AssignDormitoryController::class,"destroy"])->name("assign_dormitory.delete");
Route::resource("assign_dormitory", AssignDormitoryController::class)->parameters(["assign_dormitory" => "assign_dormitory"]);
/**Department**/
